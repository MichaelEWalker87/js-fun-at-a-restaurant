...
var food = 'Ice Cream Tacos';
var type = 'Best Dessert';
var inStock = 12;
...
//uhhhhhh less than 1? ^ ummm okay and was set to inStock but I am going to assume === stockCount
...
var vegetables = ['Artichoke', 'Broccoli Rabe', 'Leeks', 'Peppers', 'Shallots']
...
// different fruits.
var fruits = ['Avocado', 'Guava', 'Jackfruit', 'Plum', 'Peach', 'Plantain', 'Prickly Pear']
...
var groceryStore = {
  name: 'Mustash Mikes Grocery Emporium',
  isOpen: true,
}
...
groceryStore.location = '70, 7320 US-54, Alamogordo, NM 88310';
console.log(groceryStore);
//this address is a little nutty
